/**
 *
 * This the pure-MPI programme on ARCHER. We add a timer in it and remove some useless code to keep the output clean.
...
int main(int argc, char **argv)
{
   ...
   *
  **/
  double tstart, tstop1,tstop2,ttot_iter,ttot_comp,ttot_comm;
