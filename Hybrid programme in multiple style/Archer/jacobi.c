/**
 *
 * This file focuses on jacobi algorithm.
 * It introduce a new parameter, myid, to the function to know the thread number.
 * Every thread visit and process a part of the grid in the rank.
 *
**/
#include <stdio.h>
