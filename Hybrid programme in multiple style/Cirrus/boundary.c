/**
 *
 * This file focuses on halo swapping.
 * It introduce a num function to do halo swapping in every thread.
 * In that function, the tag is set to myid*100, to distinguish the different communications in every rank.
 *
**/
#include "boundary.h"
#include <stdio.h>
...
/**
 *
 * This function swaps halos in every thread.
 *
**/
